...
router.get('/', async (req, res) => {
  ...
  try { 
    ...
    const categoryData = await Category.findAll({ //findAll() returns an array of Category instances
      include: [{model: Category}] // include the Category model in the results 
    });
